    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {jobs.map(job => (
                    <div key={job._id} className="bg-white p-6 rounded-lg shadow-md border-t-4 border-primary hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col h-full">
                        ...
                        <Link
                            ...
                            className="block text-center bg-primary text-white py-3 rounded-lg hover:bg-primary-light transition shadow font-bold mt-auto"
                        >
                            View Details & Apply
                        </Link>
                    </div>
